namespace ClickableTransparentOverlay
{
    ...
    public abstract class Overlay : IDisposable
    {
        ...
        /// </summary>
        public Overlay() : this(T.GetString("yd3DAgEE7jRRzlli", "Overlay"))
        {
        }
        ...
        /// </param>
        public Overlay(bool DPIAware) : this(T.GetString("yd3DAgEE7jRRzlli", "Overlay"), DPIAware)
        {
        }
        ...
        protected virtual void Dispose(bool disposing)
        {
            ...
            if (this.selfPointer != IntPtr.Zero)
            {
                ...
                {
                    throw new Exception(T.GetString("yd3DAgEE7jRRzlli", "Failed to Unregister class during dispose."));
                }
        ...
        private async Task InitializeResources()
        {
            ...
            {
                throw new Exception(T.GetString("yd3DAgEE7jRRzlli", "Failed to Register class of name"));
            }
