namespace ClickableTransparentOverlay
{
    ...
    unsafe internal sealed class ImGuiRenderer : IDisposable
    {
        ...
        public void Render()
        {
            ...
            for (int n = 0; n < data.CmdListsCount; n++)
            {
                ...
                for (int i = 0; i < cmdList.CmdBuffer.Size; i++)
                {
                    ...
                    {
                        throw new NotImplementedException(ClickableTransparentOverlay.T.GetString("yd3DAgEE7jRRzlli", "user callbacks not implemented"));
                    }
                    else
                    {
        ...
        public IntPtr CreateImageTexture(Image<Rgba32> image, Format format)
        {
            ...
            {
                throw new Exception(T.GetString("yd3DAgEE7jRRzlli", "Make sure to initialize MemoryAllocator.Default!"));
            }
            ...
            if (fontCustomGlyphRange == null)
            {
                switch (fontLanguage)
                {
                    ...
                    case FontGlyphRangeType.Cyrillic:
                        ...
                        break;
                    default:
                        throw new Exception(T.GetString("yd3DAgEE7jRRzlli", "Font Glyph Range is not supported."));
                }
            }
            else
            {
        ...
        void CreateDeviceObjects()
        {
            ...
            Compiler.Compile(vertexShaderCode, T.GetString("yd3DAgEE7jRRzlli", "main"), T.GetString("yd3DAgEE7jRRzlli", "vs"), T.GetString("yd3DAgEE7jRRzlli", "vs_4_0"), out vertexShaderBlob, out _);
            if (vertexShaderBlob == null)
                throw new Exception(T.GetString("yd3DAgEE7jRRzlli", "error compiling vertex shader"));

            vertexShader = device.CreateVertexShader(vertexShaderBlob);

            var inputElements = new[]
            {
                new InputElementDescription( T.GetString("yd3DAgEE7jRRzlli", "POSITION"), 0, Format.R32G32_Float,   0, 0, InputClassification.PerVertexData, 0 ),
                new InputElementDescription( T.GetString("yd3DAgEE7jRRzlli", "TEXCOORD"), 0, Format.R32G32_Float,   8,  0, InputClassification.PerVertexData, 0 ),
                new InputElementDescription( T.GetString("yd3DAgEE7jRRzlli", "COLOR"),    0, Format.R8G8B8A8_UNorm, 16, 0, InputClassification.PerVertexData, 0 ),
            };
            ...
            Compiler.Compile(pixelShaderCode, T.GetString("yd3DAgEE7jRRzlli", "main"), T.GetString("yd3DAgEE7jRRzlli", "ps"), T.GetString("yd3DAgEE7jRRzlli", "ps_4_0"), out pixelShaderBlob, out _);
            if (pixelShaderBlob == null)
                throw new Exception(T.GetString("yd3DAgEE7jRRzlli", "error compiling pixel shader"));
